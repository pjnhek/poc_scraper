...
- [x] **DEMO-01**: Re-record the walkthrough against the final pipeline on the real CSV (published on kommodo.ai); pin the commit SHA referenced in the README to the recorded state.

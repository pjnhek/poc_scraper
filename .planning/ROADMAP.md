...
- [x] 07-02-PLAN.md -- tests/unit/test_check_public_discipline.py (REPO-04): parametrized content-match and path-match coverage for the pre-commit guard; uses publishable fake term per D-05

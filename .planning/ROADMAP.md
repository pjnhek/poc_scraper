...
- [ ] 10-04-PLAN.md — Gap closure: enforce the serialized evidence byte budget and reject malformed domains before provider access
...
| 10. Stdio MCP Server (Thin Tier) | v1.1 | 3/4 | In Progress|  |

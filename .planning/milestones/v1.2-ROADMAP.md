...
- [x] **Phase 14: Deterministic Scoring & Guided Flow** - Agents get a server-guaranteed ICP score alongside their cited evidence, orchestrated end-to-end by the research prompt (completed 2026-07-18)
...
- [x] 14-01-PLAN.md — Deterministic score_account tool (scoring.py + server wiring + unit/functional/integration tests)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 14-02-PLAN.md — news_days clamped threading to Exa + research_account guided-flow prompt rewrite

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 14-03-PLAN.md — README + Oracle landing-page hybrid-framing docs, full offline gate
